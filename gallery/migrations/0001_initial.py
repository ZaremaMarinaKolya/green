    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_image', models.ImageField(blank=True, help_text='Выберите миниатюру', null=True, upload_to='', verbose_name='Миниатюра')),
                ('name', models.CharField(default='Изображения', max_length=250, verbose_name='Название изображения')),
